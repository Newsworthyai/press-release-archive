# Nvidia Is Up Over 150% YTD, But Some Are Flagging Risks – Trade Your Expectation Either Way With REX Shares Leveraged ETFs

By Meg Flippin, Benzinga

![Want leveraged Nvidia exposure on the upside or downside? REX Shares ETFs offer you both.](https://public.newsdirect.com/771149912/mRhiX6rv.png)
...
An investor should carefully consider a Fundâs investment objective, risks, charges, and expenses before investing. A Fundâs prospectus and summary prospectus contain this and other information about the REX Shares. To obtain a Fundâs prospectus and summary prospectus call 844-802-4004. A Fundâs prospectus and summary prospectus should be read carefully before investing.
...
NVIDIA Corporation Investing Risk â NVIDIA Corporation faces risks associated with meeting the evolving needs of its large markets â gaming, data center, professional visualization and automotive â and identifying new products, services and technologies; competition in its current and target markets; changes in customer demand.

Important Information Regarding 2X NVDA Fund. The T-REX 2x Long NVIDIA Daily Target ETF (NVDX) seeks 2X% daily leveraged investment results and thus will have an increase of volatility relative to the NVDA performance itself. Longer holding periods, higher volatility of NVDA and leverage increase the impact of compounding on an investorâs returns. During periods of higher volatility, the volatility of NVDA may affect the fundâs performance.

Important Information Regarding -2X NVDA Fund. The T-REX 2X Inverse NVDA Daily Target ETF (NVDQ) seeks daily inverse investment results and is very different from most other exchange-traded funds. Longer holding periods and higher volatility of NVDA increase the impact of compounding on an investorâs returns. During periods of higher volatility, the volatility of NVDA may affect the fundâs return as much as, or more than, the return of NVDA.
...
Distributor: Foreside Fund Services, LLC, member FINRA, not affiliated with REX Shares or the Fundsâ investment advisor.
...
[Reddit Post](https://www.reddit.com/r/FinancialNewsramp/comments/1f2jfl3/nvidia_set_to_report_earnings_trade_your/) 



![Blockchain Registration](https://cdn.newsramp.app/news-direct/qrcode/248/27/apexWKh3.webp)