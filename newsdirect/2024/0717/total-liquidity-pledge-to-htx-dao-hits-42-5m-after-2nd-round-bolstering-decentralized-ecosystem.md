...
HTX DAO has announced its receipt of the second Ecosystem Liquidity Pledge took place on July 16, 2024. Through this pledge, 80,223,880 TRX and 9,631,105,301,954.7 $HTX (worth 21,500,000 USDT) have been allocated to SUN.io to enhance liquidity and all LP tokens have been credited to a zero address. As of press, HTX DAO has reportedly received a total liquidity pledge of $42.5 million.

The pledge details can be viewed based on the following transaction hash via TRONSCAN, the TRON blockchain explorer. (The amount of $HTX tokens contributed to liquidity is calculated based on the real-time price of $HTX.)
