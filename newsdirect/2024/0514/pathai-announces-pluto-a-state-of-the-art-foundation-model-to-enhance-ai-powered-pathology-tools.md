...
PLUTO and its adaptations are set to power PathAI’s best-in-class suite of AI products2 for diagnostic pathology labs and biopharma use. PLUTO will be adapted to develop the next generation of PathAI’s best-in-class products. PLUTO’s embeddings will enable prediction of underlying molecular alterations driving cancer and disease phenotypes–including those previously hidden to AI–as well as the discovery of new biomarkers and therapeutic targets.
