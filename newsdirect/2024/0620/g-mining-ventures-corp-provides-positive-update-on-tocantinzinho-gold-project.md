...
Gignac informed Proactive that ore was introduced into the grinding circuit on June 10, following the receipt of the hot commissioning permit from the Pará State Environmental Agency (SEMAS). These permits allow for the mining and processing of ore, disposal of tailings, as well as the selling and exporting of gold. Once the project reaches a steady state, the Tocantinzinho Gold Project (TZ) is set to become Brazil’s third-largest primary gold mine.
