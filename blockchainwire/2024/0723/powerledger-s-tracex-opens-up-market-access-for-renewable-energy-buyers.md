...
Powerledger, an energy software company,has introduced a new feature in its TraceX marketplace, enabling organizations to purchase Renewable Energy Certificates (RECs) directly from renewable energy generators.
...
1. Direct access to generators: Business customers can purchase RECs directly from specific projects, ensuring they know exactly where their renewable energy is coming from.
2. Transparent pricing: The platform provides clear insight into the cost of RECs, enabling REC buyers to understand the true value of their purchases.
3. Enhanced trust and accountability: All the REC attribute data for every bundle listed is available to the buyers ahead of REC purchases, fostering confidence and trust in REC transactions and meeting specific voluntary standards.
4. User-friendly interface: The platform is designed for ease of use, making the process of purchasing RECs straightforward and accessible to all buyers, regardless of their experience level.
...
[Reddit Post](https://www.reddit.com/r/Energy_Climate_News/comments/1eabzxz/powerledger_introduces_new_feature_for_direct/) 



![Blockchain Registration](https://cdn.newsramp.app/blockchainwire/qrcode/247/23/bold2UPX.webp)