...
1. The first step is the wallet selection: Users should opt for a wallet compatible with Wallet Connect. Trust Wallet or Plus Wallet are recommended choices by BlockDAG for general usage, while MetaMask is ideal for desktop browsers.
2. The second move is to create a personal account by filling in the required details and establishing a safe password.
3. The third step is to head to the BlockDAG official website and select the "Buy" option, making sure to connect the to then proceed with the purchase. BlockDAG Network has so far supported USDT (Tether), ETH (Ethereum), or BNB (Binance Coin) for BDAG purchases. However, from today, 10 more cryptocurrencies were added to the list such as Bitcoin (BTC), Kaspa (KAS), Solana (SOL), USDT (Tron) and more.
4. Last step is to wait and watch the investment grow. Upon completing the presale, BDAG coins will be distributed to you via an airdrop. This is the distribution method that best ensures a fair and transparent allocation of coins to all buyers.
...
![](https://blockchainwire.s3.amazonaws.com/Proleoio/editor_image/d0df0f2e-08c2-4b74-ad7c-8ceacb2abd8f.png)
...
[Reddit Post](https://www.reddit.com/r/CryptoNewsInfo/comments/1cieump/blockdag_network_expands_payment_options_for_bdag/) 



![Blockchain Registration](https://cdn.newsramp.app/blockchainwire/qrcode/245/2/maskA_9Y.webp)