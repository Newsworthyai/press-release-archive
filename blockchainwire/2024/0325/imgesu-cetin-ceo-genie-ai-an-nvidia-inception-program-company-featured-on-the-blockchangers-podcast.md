...
Enzo Villani, CEO, Alpha Transform Holdings (ATH) and Managing Partner of Alpha Sigma Capital funds, a leading digital asset investment and advisory organization, interviews Imgesu Cetin, CEO & Founder, of Genie AI. Genie AI was recently invited to join NVIDIA's Inception Program, the program nurtures start-ups revolutionizing industries with tech advancements.

Watch Podcast here.

Utilizing a gen-ai-sql technology, Genie AI automates the writing of complex queries to get to insights in seconds. Their three unique product offerings, Slack Bot, Cloud-base and Self Hosted, help clients' with data discovery, investment strategy and business intelligence.

(FAIR DISCLOSURE: Alpha Sigma Capital funds is an investor in Genie AI (formerly DefyTrends.)

About Genie AI

Founded by Imgesu Cetin in 2020, Genie AI (formerly DefyTrends) is the next evolution of data query tool. Genie is an AI data analyst that empowers business users to query and visualize their data without the hassle of complex SQL Genie is revolutionizing the way teams do data analytics. Genie is an AI data analyst that never sleeps. Utilizing a gen-ai-sql technology, Genie automates the writing of complex queries to get to insights in seconds. This helps with clients' data discovery, investment strategy and business intelligence. We have 3 unique product offerings: Slack bot, cloud-based, and self-hosted. We also provide custom integrations for our clients, offering air-gapped solutions that allow them to retain full control of their data. Website: https://opengenie.ai/
...
[Reddit Post](https://www.reddit.com/r/CryptoNewsInfo/comments/1bneqra/enzo_villani_ceo_of_alpha_transform_holdings/) 



![Blockchain Registration](https://cdn.newsramp.app/blockchainwire/qrcode/243/25/ovalDhmX.webp)