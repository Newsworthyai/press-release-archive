# Mississippi Dental Association Expands Partnership With Cloud Software Leader iCoreConnect

OCOEE, FL - (NewMediaWire) - September 09, 2024 - iCoreConnect Inc. (NASDAQ: ICCT), a leading provider of cloud-based software and technology solutions, has announced an expanded partnership with the Mississippi Dental Association (MDA). The MDA now endorses seven of iCoreConnect’s products, broadening its initial endorsement of the company’s cloud-based electronic prescribing software.
...
●      iCoreCodeGenius - Fast ICD-10 coding

●      iCoreClaims - Dental claims and billing

●      iCoreIT- Managed IT services

●      iCorePay - Statements, payments, and billing solutions
