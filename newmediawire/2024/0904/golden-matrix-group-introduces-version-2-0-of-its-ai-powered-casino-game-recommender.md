...
LAS VEGAS, NV - (NewMediaWire) - September 04, 2024 - Golden Matrix Group (NASDAQ: GMGI) today announced the launch of Version 2.0 of its AI-powered casino game recommender, developed by its subsidiary, Meridianbet.

 This update specifically targets the iGaming segment, enhancing personalization and tracking capabilities to improve user engagement, retention, and revenue performance.

 Precision Personalization for Improved User Targeting

 The V2 recommender now processes an expanded dataset, including player behaviors and demographics, delivering more precise game recommendations that resonate with individual preferences, offering advanced AI-driven insights:

 Proven Impact on Key Revenue Metrics

 Initial data shows significant increases in user interaction and retention, with personalized recommendations driving higher player value and extended playtime.

 Expanded Availability Across All Platforms

 V2 is now fully operational on core Meridianbet websites featuring casino games, with plans to extend functionality to mobile apps. This broad rollout is expected to further enhance user engagement and platform profitability.

 Strategic Growth in the iGaming Segment

 The V2 upgrade is a key component of Golden Matrix Group’s strategy to leverage AI and data analytics within the iGaming sector, under its Meridianbet division. This enhancement strengthens the company’s position in key markets and supports ongoing efforts to drive sustainable growth.
...
[Reddit Post](https://www.reddit.com/r/newsramp/comments/1f9gwq9/golden_matrix_group_launches_aipowered_casino/) 



![Blockchain Registration](https://cdn.newsramp.app/newmediawire/qrcode/249/5/boldYqbM.webp)